...
export const TablaC = () => {
  ...
  const handleDestacar = (id) => {
    ...
    Swal.fire({
      icon: "success",
      title: peliculaSeleccionada.destacado
        ? "Película desmarcada como destacada"
        : "Película marcada como destacada",
      text: peliculaSeleccionada.destacado
        ? "La película ya no está destacada."
        : "La película ahora está destacada.",
    });
  };
  ...
  const handleEliminar = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const peliculasActualizadas = peliculasLS.filter(
          (filtro) => filtro.id !== id
        );
        ...
        Swal.fire("Cancelado", "La película no ha sido eliminada.", "info");
      }
    });
  };
  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center justify-content-lg-end align-items-center mt-3 pe-lg-5">
        <Link to="/admin/crear-peliculas" className="btn btn-style">
          Añadir Películas
        </Link>
      </div>
              ...
              <tr key={peli.id}>
                ...
                <td>
                  <div className="d-flex gap-3">
                    ...
                    <Link
                      to={`/admin/crear-peliculas?id=${peli.id}`}
